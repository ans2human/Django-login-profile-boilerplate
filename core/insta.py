...
account = "samitto_kumar_mallick"

def login(driver):
    username = "samitto_kumar_mallick"  # <username here>
    password = "admin@123"  # <password here>
...
def scrape_followers(driver, account):
    ...
    waiter.find_element(driver, "//a[@href='/samitto_kumar_mallick/followers/']", by=XPATH).click()
